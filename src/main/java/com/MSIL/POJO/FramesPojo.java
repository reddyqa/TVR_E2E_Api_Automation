...
public class FramesPojo {

	
	private frames frames;
	private framesPictures framesPictures;
	...
	public framesPictures getFramesPictures() {
		return framesPictures;
	}
	public void setFramesPictures(framesPictures framesPictures) {
		this.framesPictures = framesPictures;
	}
