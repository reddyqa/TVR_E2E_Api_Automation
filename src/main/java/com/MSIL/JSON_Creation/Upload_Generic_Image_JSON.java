...
import com.MSIL.POJO.Upload_Generic_Image_POJO;
import com.MSIL.Setup.BaseSetup;
import com.google.gson.Gson;

public class Upload_Generic_Image_JSON extends BaseSetup
{ 
	@SuppressWarnings({ "rawtypes", "unchecked"})
	public static String Generic_Image(Hashtable<String, String> map, ITestContext context) {
		String jsonString = null;

		Upload_Generic_Image_POJO GI=new Upload_Generic_Image_POJO();
		...
		while (itr.hasNext()) {
			...
			if (key.equals("evaluationId")) {
				if (value.equals("null") || value.equals("")) {
					GI.setEvaluationId(null);
				} else {
					GI.setEvaluationId(value);
				}
