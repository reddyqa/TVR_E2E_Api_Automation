...
import com.MSIL.JSON_Creation.Certification.Certi_Frames_Json;
...
public class Certi_Frames_API {
	...
	public static void FramesAPI1(Hashtable<String, String> data, ITestContext context, String sheetname) {
	

		Map<String, Object> map = new HashMap<>();

		Certi_Frames_Json frames = new Certi_Frames_Json();
	

		RequestSpecification request = RestAssured.given(); 
		
		String requestBody = frames.Frames(data, context);
