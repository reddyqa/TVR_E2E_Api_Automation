...
public class ExteriorImageUpload 
{
	...
	public static void uploadEximg(Hashtable<String, String> data, ITestContext context, String sheetname)
	{
		...
		System.out.println(data.get("evaluationId"));
		...
		if(status_code!=200) {
			...
			String evaluationId =jsonPathEvaluator.get("message"); 
			...
			if((rowNum-1)%14==0)//num % 14 == 0:
			{
				...
				er.setCellData("Exterior", "fixedS3PresignedUrl", h, String.valueOf(fixedS3PresignedUrlSTRBULd));
