...
public class InteriorAPI {
	...
	public static void InteriorAPI1(Hashtable<String, String> data, ITestContext context, String sheetname) {
	

		Map<String, Object> map = new HashMap<>();

		InteriorJson interior = new InteriorJson();

		RequestSpecification request = RestAssured.given(); 
		
		String requestBody = interior.Interior(data, context);
