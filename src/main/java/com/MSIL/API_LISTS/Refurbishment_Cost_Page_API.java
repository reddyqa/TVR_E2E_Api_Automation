...
import com.MSIL.JSON_Creation.Refurbishment_Cost_Page_JSON;
...
public class Refurbishment_Cost_Page_API {
	...
	public static void Refurbishment_Cost_API(Hashtable<String, String> data, ITestContext context, String sheetname) {
		...
		Refurbishment_Cost_Page_JSON rfcost = new Refurbishment_Cost_Page_JSON();

		RequestSpecification request = RestAssured.given();
		String requestBody = rfcost.Refurbishment_Cost(data, context);
