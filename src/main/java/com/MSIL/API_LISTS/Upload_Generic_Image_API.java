...
import com.MSIL.JSON_Creation.Upload_Generic_Image_JSON;
...
public class Upload_Generic_Image_API {
	...
	public static void Upload_Generic_Image(Hashtable<String, String> data, ITestContext context, String sheetname) {
		...
		Response response=request.header("Content-Type", "multipart/form-data").formParam("evaluationId",data.get("evaluationId1") )
